...
<!--                         </li> -->
                        ...
                        <li> <a href="node.php" aria-expanded="false"><i class="icon-speedometer"></i>Add Node</a>

                        </li>
                        <li> <a  href="examadmin.php" aria-expanded="false"><i class="ti-layout-grid2"></i>Exam Admin</a>
                            
                        </li>
                        <li> <a href="examsubject.php" aria-expanded="false"><i class="ti-email"></i>Exam Subject</a>

                        </li>
                        <li> <a href="examsubjectnode.php" aria-expanded="false"><i class="ti-palette"></i>Exam Subject Node</a>

                        </li>
                        <li> <a href="distribute_paper.php" aria-expanded="false"><i class="ti-email"></i>Distribute Paper</a> 
                        </li>
                        <li> <a href="student.php" aria-expanded="false"><i class="ti-email"></i>Student List</a> 
                        </li>
                      
<!--                         <li class="nav-small-cap">--- FORMS, TABLE &amp; WIDGETS</li> -->
<!--                         <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-media-right-alt"></i><span class="hide-menu">Vehicle</span></a> -->
<!--                             <ul aria-expanded="false" class="collapse"> -->
